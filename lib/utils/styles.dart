...
List<BoxShadow>? searchBoxShadow = Get.find<ThemeController>().darkTheme
    ? null
    : [
        const BoxShadow(
            offset: Offset(0, 3),
...
//card boxShadow
List<BoxShadow>? cardShadow = Get.find<ThemeController>().darkTheme
    ? [const BoxShadow()]
    : [
        BoxShadow(
...
List<BoxShadow>? cardShadow2 = Get.find<ThemeController>().darkTheme
    ? [const BoxShadow()]
    : [
        BoxShadow(
          offset: const Offset(0, 1),
          blurRadius: 2,
          color: const Color(0xFF4153B3).withOpacity(0.15),
        )
      ];
